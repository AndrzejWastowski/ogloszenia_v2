...
class ServicesPhoto extends Model
{
    ...
    protected $fillable = ['id', 'services_contents_id', 'name', 'sort',];
    ...
    */
    ...
    public function get_services_contents_id():int 
    {
        return $this->services_contents_id;
    }
    ...
    */
    ...
    public function set_services_contents_id(?int $value): void
    {
        $this->services_contents_id = $value;
    }
