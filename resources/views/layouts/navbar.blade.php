                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="index.html"><i
                                        class='bx bx-pie-chart-alt'></i>Analytics</a></li>
                            <li><a class="dropdown-item" href="index2.html"><i class='bx bx-shield-alt-2'></i>Sales</a>
                            </li>
                            <li><a class="dropdown-item" href="index3.html"><i class='bx bx-cart'></i>eCommerce</a></li>
                            <li><a class="dropdown-item" href="index4.html"><i
                                        class='bx bx-window-alt'></i>Alternate</a></li>
                            <li><a class="dropdown-item" href="index5.html"><i
                                        class='bx bx-briefcase'></i>Hospitality</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="index4.html"><i class='bx bx-window-alt'></i>Działki Rolne</a></li>
                            <li><a class="dropdown-item" href="index5.html"><i class='bx bx-briefcase'></i>Biura</a></li>
                            <li><a class="dropdown-item" href="index5.html"><i class='bx bx-briefcase'></i>Gospodarcze</a></li>
                            <li><a class="dropdown-item" href="index5.html"><i class='bx bx-briefcase'></i>Garaże</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
