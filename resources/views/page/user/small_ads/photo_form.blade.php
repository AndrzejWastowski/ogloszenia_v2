                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xl-9 mx-auto">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="file-upload-form" name="file-upload-form" method="POST"
                                                action="{{ route('page.user.small_ads.photo_send') }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <input id="image-uploadify" type="file" name="file[]" accept="image/*"
                                                    multiple>
                            ...
                            <div class="mb-3">
                                <div class="text-end">
                                    <a href="{{ route('page.user.small_ads.promotion_form') }}" type="submit" class="btn btn-primary">
                                        {{ __('Dalej') }}
                                    </a>
                                </div>
                            </div>
